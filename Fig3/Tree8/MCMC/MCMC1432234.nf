...
echo true
  ...
  input:
    ...
    each rand from  1432234
    each alphaSMCSampler from 0.99
    each ntaxa from  (10, 15, 20, 25, 30, 35, 40)
...
java   -cp 'code/lib/*' -Xmx8G   smcsampler.SMCSamplerExperiments -useDataGenerator true    -nThousandIters 0.001 \
     -nTax $ntaxa  \
     -len  100 \
     -sequenceType DNA \
